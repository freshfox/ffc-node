...
OldValidator.register('boolean', (val) => {
	return typeof val == 'boolean';
});

OldValidator.register('boolish', (val) => {
	return typeof val == 'boolean' || val === 1 || val === 0;
});

OldValidator.register('optional', () => {
	return true;
});

OldValidator.register('dateTime', (val) => {
	return moment(val, moment.ISO_8601, true).isValid();
});

OldValidator.register('dateString', (dateString) => {
